    ...
    fun startNpcClient(param: String) {
        ...
        ThreadPoolCommon.scheduled.execute {
            try {
                ...
                process = Runtime.getRuntime().exec("${property}${File.separator}src${File.separator}main${File.separator}resources${File.separator}npc${File.separator}npc.exe $param")
